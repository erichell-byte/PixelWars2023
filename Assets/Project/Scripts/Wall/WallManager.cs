...
namespace Wall
{
    public class WallManager
    {
        ...
        public Vector2 farCameraCorner;
        ...
        private Cube CreateCubeAt(int x, int y)
        {
            ...
            FindFarthestCube(cubePosition.x, cubePosition.y);
        ...
        private void FindFarthestCube(float cubePositionX, float cubePositionY)
        {
            if (cubePositionX > farCameraCorner.x)
                farCameraCorner.x = cubePositionX;
            if (cubePositionY > farCameraCorner.y)
                farCameraCorner.y = cubePositionY;
        }
