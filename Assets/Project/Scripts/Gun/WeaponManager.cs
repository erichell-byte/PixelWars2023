...
namespace Weapon
{
    public class WeaponManager
    {
        ...
        public WeaponManager(WeaponReferences references, Crosshair crosshair)
        {
            ...
            _crosshair.PositionUpdated += newPosition => currentWeapon.LookAt(newPosition);
        ...
        public void UntrackedMouseMovement()
        {
            _crosshair.ShootStarted -= WeaponStartShoot;
            _crosshair.ShootStopped -= WeaponStopShoot;
            _crosshair.PositionUpdated -= newPosition => currentWeapon.LookAt(newPosition);
            ResetWeapon();
        }
        
        public void TrackedMouseMovement()
        {
            _crosshair.ShootStarted += WeaponStartShoot;
            _crosshair.ShootStopped += WeaponStopShoot;
            _crosshair.PositionUpdated += currentWeapon.LookAt;
            ResetWeapon();
        }
